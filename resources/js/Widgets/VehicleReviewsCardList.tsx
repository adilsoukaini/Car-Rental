...
/**
 * Card List review display (the default `reviewDisplay` layout variant) —
 * each review is a full card/row with author name, rating, title, body,
 * date, and verified-rental badge. Registered as
 * `Widgets/VehicleReviewsCardList` via LayoutVariantRegistry.
 */
export default function VehicleReviewsCardList({ vehicleId, reviewsData }: { vehicleId: number; reviewsData: ReviewsData }) {
